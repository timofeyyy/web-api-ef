...
namespace app.Migrations
{
    ...
    [Migration("20251019130907_Countries-Foreigners")]
    partial class CountriesForeigners
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("app.Models.Ef.ComponentTypes", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("app.Models.Ef.Diods", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("app.Models.Ef.Resistors", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("app.Models.Ef.Transistors", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("app.Entities.Capacitors", b =>
                {
                    ...
                    b.HasOne("app.Models.Ef.Manufacturers", "Manufacturer")
                        .WithMany("Capacitors")
                        .HasForeignKey("ManufacturerName_ID");

                    b.HasOne("app.Models.Ef.ComponentTypes", "Type")
                        .WithMany("Capacitors")
            ...
            modelBuilder.Entity("app.Models.Ef.Microchips", b =>
                {
                    ...
                    b.HasOne("app.Models.Ef.Technologies", "Technology")
                        .WithMany("Microchips")
