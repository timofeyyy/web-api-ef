...
namespace app.Migrations
{
    ...
    [Migration("20250220131947_fkeys")]
    partial class fkeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("app.Entities.Capacitors", b =>
                {
                    ...
                    b.HasOne("app.Entities.Manufacturers", "Manufacturer")
                        .WithMany("Capacitors")
                        .HasForeignKey("ManufacturerName_ID");

                    b.HasOne("app.Entities.ComponentTypes", "Type")
                        .WithMany("Capacitors")
            ...
            modelBuilder.Entity("app.Entities.Microchips", b =>
                {
                    ...
                    b.HasOne("app.Entities.Technologies", "Technology")
                        .WithMany("Microchips")
